...
/**
 	* A data access object (DAO) providing persistence and search support for Page entities.
...
public class PageDao  {
    ...
    public Page findById( java.lang.String id) {
        ...
        try {
            Page instance = (Page) getCurrentSession()
                    .get("Page", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Page instance) {
        ...
        try {
            List results = getCurrentSession().createCriteria("Page") .add(Example.create(instance)).list();
