...
/**
 	* A data access object (DAO) providing persistence and search support for ResourceType entities.
...
public class ResourceTypeDao  {
	     private static final Logger log = LoggerFactory.getLogger(ResourceTypeDao.class);
		//property constants
    ...
    public void save(ResourceType transientInstance) {
        log.debug("saving ResourceType instance");
        try {
    ...
    public ResourceType findById( java.lang.String id) {
        ...
        try {
            ResourceType instance = (ResourceType) getCurrentSession()
                    .get("ResourceType", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(ResourceType instance) {
        ...
        try {
            List results = getCurrentSession().createCriteria("ResourceType") .add(Example.create(instance)).list();
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding ResourceType instance with property: " + propertyName
            + ", value: " + value);
      try {
	...
	public List findAll() {
		log.debug("finding all ResourceType instances");
		try {
    ...
    public ResourceType merge(ResourceType detachedInstance) {
        ...
        try {
            ResourceType result = (ResourceType) getCurrentSession()
    ...
    public void attachDirty(ResourceType instance) {
        log.debug("attaching dirty ResourceType instance");
        try {
    ...
    public void attachClean(ResourceType instance) {
        log.debug("attaching clean ResourceType instance");
        try {
	...
	public static ResourceTypeDao getFromApplicationContext(ApplicationContext ctx) {
